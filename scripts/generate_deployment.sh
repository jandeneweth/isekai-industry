...
cp -rT ${STATIC_DIR}/converted_extensions ${BUILD_MOD_DIR}
cp -rT ${STATIC_DIR}/mod_custom ${BUILD_MOD_DIR}

# Run scripts
python ${SCRIPT_DIR}/update_country_histories.py ${BUILD_MOD_DIR}
python ${SCRIPT_DIR}/update_country_definitions.py ${BUILD_MOD_DIR}
python ${SCRIPT_DIR}/update_subject_relationships.py ${BUILD_MOD_DIR}
